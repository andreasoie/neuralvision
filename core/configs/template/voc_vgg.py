...
import torch
import torchvision
from core.backbones.vgg import VGG
from core.datasets_classes.voc_dataset import VOCDataset
from core.tops.config.lazy import LazyConfig as L
...
from core.configs.template.ssd300 import (
    anchors,
    data_train,
    data_val,
    loss_objective,
