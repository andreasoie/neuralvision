...
class BiFPN(nn.Module):
    def __init__(self, fpn_sizes):
        ...
        self.p3_out_conv = nn.Conv2d(
            P3_channels, self.W_bifpn, kernel_size=3, stride=1, bias=True, padding=1
        )
        ...
        self.p7_out_conv = nn.Conv2d(
            P7_channels, self.W_bifpn, kernel_size=3, stride=1, bias=True, padding=1
        )
    ...
    def forward(self, inputs):
        ...
        P6_td = self.p6_td_conv_2(
            (self.p6_td_w1 * P6_td_inp + self.p6_td_w2 * P7_td)
