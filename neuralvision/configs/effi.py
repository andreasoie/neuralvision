...
import torchvision
from neuralvision.backbones.efficientnet import EfficientNet
...
from neuralvision.ssd.effinanet import EffinaNet
...
backbone = L(EfficientNet)(coef=2, pretrained=True)
